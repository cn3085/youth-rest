...
public class P6spyLogMessageFormatConfig {
	...
	public void setLogMessageFormat() {
        P6SpyOptions.getActiveInstance().setLogMessageFormat(P4spySqlFormatConfig.class.getName());
    }
	
	public static class P4spySqlFormatConfig implements MessageFormattingStrategy {
