...
public class ContentsController {
	...
	public ResponseEntity<ResponseDTO> getThisMember(@PathVariable Long contentsId){
	...
	public ResponseEntity<ResponseDTO> deleteMember(@PathVariable Long contentsId){
	...
	public ResponseEntity<ResponseDTO> updateMember(@PathVariable Long contentsId,
